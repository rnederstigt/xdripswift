...
- **Display settings:** the last explicit phone units and four glucose limits are restored before collection after Watch restart, also in ordinary relay mode. Fresh units/limits updates may be accepted during direct mode through the existing status hook. These persistence changes were explicitly requested.
